const Assessment_typeModel = require("./assessment_type.model");
...
module.exports = {
  ...
  create: function (req, res) {
    const assessment_type = new Assessment_typeModel({
  ...
  update: function (req, res) {
    ...
    Assessment_typeModel.findOne({ _id: id }, function (err, assessment_type) {
      ...
      assessment_type.assessment_type_description = req.body
        .assessment_type_description
        ? req.body.assessment_type_description
        : assessment_type.assessment_type_description;
