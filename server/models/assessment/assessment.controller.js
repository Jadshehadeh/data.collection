const AssessmentModel = require("./assessment.model.js");
...
module.exports = {
  ...
  update: function (req, res) {
    ...
    AssessmentModel.findOne({ _id: id }, function (err, assessment) {
      ...
      assessment.assessment_typeId = req.body.assessment_typeId
        ? req.body.assessment_typeId
        : assessment.assessment_typeId;
      assessment.patientId = req.body.patientId
        ? req.body.patientId
        : assessment.patientId;
      assessment.assessment_date = req.body.assessment_date
        ? req.body.assessment_date
        : assessment.assessment_date;
      assessment.is_IDP = req.body.is_IDP ? req.body.is_IDP : assessment.is_IDP;
      assessment.is_refugee = req.body.is_refugee
        ? req.body.is_refugee
        : assessment.is_refugee;
      assessment.is_patient_registrar = req.body.is_patient_registrar
        ? req.body.is_patient_registrar
        : assessment.is_patient_registrar;
      assessment.registrarId = req.body.registrarId
        ? req.body.registrarId
        : assessment.registrarId;
      assessment.email = req.body.email ? req.body.email : assessment.email;
      assessment.cell_number = req.body.cell_number
        ? req.body.cell_number
        : assessment.cell_number;
      assessment.occupation = req.body.occupation
        ? req.body.occupation
